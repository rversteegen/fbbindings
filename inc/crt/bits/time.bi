...
const CLOCKS_PER_SEC = cast(clock_t, 1000000)
...
const MOD_OFFSET = ADJ_OFFSET
const MOD_FREQUENCY = ADJ_FREQUENCY
const MOD_MAXERROR = ADJ_MAXERROR
const MOD_ESTERROR = ADJ_ESTERROR
const MOD_STATUS = ADJ_STATUS
const MOD_TIMECONST = ADJ_TIMECONST
const MOD_CLKB = ADJ_TICK
const MOD_CLKA = ADJ_OFFSET_SINGLESHOT
const MOD_TAI = ADJ_TAI
const MOD_MICRO = ADJ_MICRO
const MOD_NANO = ADJ_NANO
const STA_PLL = &h0001
...
const STA_CLK = &h8000
const STA_RONLY = ((((((STA_PPSSIGNAL or STA_PPSJITTER) or STA_PPSWANDER) or STA_PPSERROR) or STA_CLOCKERR) or STA_NANO) or STA_MODE) or STA_CLK
